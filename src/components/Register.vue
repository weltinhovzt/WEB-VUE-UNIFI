  ...
  methods: {
    ...
    terms() {
      this.$swal({
        ...
        html:
          '<div class="terms">' +
          "TERMOS DE USO WIFI XXXXXX</br></br>" +
          "TERMO E CONDIÇÕES DE USO DO SERVIÇO “WI-FI NOME_EMPRESA”</br></br>" +
          "1. DEFINIÇÕES</br></br>" +
          "1.1 O Serviço WI-FI DO NOME_EMPRESA é um serviço de acesso à internet sem-fio exclusivo para a cooperativa e seus associados através de dispositivos móveis, tais como: smartphones, notebooks, tablets, etc…, onde o NOME_EMPRESA com o uso do (“firewall”) poderá limitar o acesso em determinados sites e fazer o devido controle dos usuários que estão acessando a rede. Ao Cliente que aceitar o presente Termo de uso do serviço “WI-FI NOME_EMPRESA”.</br></br>" +
          "1.2 O Serviço WI-FI NOME_EMPRESA é um serviço adicional, fornecido em caráter de cortesia, aos ASSOCIADOS de acesso à internet da cooperativa, bem como a VISITANTES e ASSOCIADOS devidamente cadastrados.</br></br>" +
          "2. UTILIZAÇÃO</br></br>" +
          "2.1 Todo ASSOCIADO que localizar a rede sem-fio WI-FI NOME_EMPRESA, poderá autenticar e utilizar os serviços, mediante a um cadastro prévio.</br></br>" +
          ...
          "3. DIREITOS DO ASSOCIADO DO WI-FI NOME_EMPRESA</br></br>" +
          ...
          "4. OBRIGAÇÕES DO ASSOCIADO e VISITANTE DO WI-FI NOME_EMPRESA</br></br>" +
          ...
          "6. FORO</br></br>" +
          "6.1 O presente instrumento obriga os usuários do WI-FI NOME_EMPRESA, a qualquer tempo, sendo neste ato eleito o foro da comarca da cidade de VAZANTE, estado de MINAS GERAIS, competente para dirimir quaisquer questões referentes ao presente, com renúncia expressa de qualquer outro, por mais privilegiado que seja.</br></br>" +
          "</div>",
